...
Dashboard interactivo desarrollado con **Dash + Python** para analizar y predecir la calidad del agua usando Machine Learning.
...
| 🔮 Predicción | Formulario interactivo para predecir la calidad del agua |
...
│
├── data/
│   └── generate_data.py    # Generación del dataset sintético
│
├── model/
...
|---|---|---|
| pH | Numérica | Nivel de acidez del agua (6.5 – 8.5) |
